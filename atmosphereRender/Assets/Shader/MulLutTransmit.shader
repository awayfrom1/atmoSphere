Shader "Atmo/MulLutTransmit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float3 col = RenderMulTransmittanceLut(i.uv, _rayMarchCount,
                ...
                _ozoneAnisotropyScale, _ozoneHeight, _ozoneWidth, _TransmittanceLut, sampler_TransmittanceLut);
                return half4(col, 1);
            }
            ENDHLSL
        }
